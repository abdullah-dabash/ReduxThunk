...
const ProductList = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white p-6 border border-gray-200 rounded-lg shadow-md mb-8">
      ...
      <ul className="space-y-4">
        {products.map((product) => (
          <li key={product.id} className="bg-white p-6 border border-gray-200 rounded-lg shadow-md">
